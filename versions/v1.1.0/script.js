...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Set initial theme to dark and check the toggle
    ...
    function toggleTheme() {
        ...
        // Force section backgrounds to update
...
const typed = new Typed('.typing-text', {
    strings: ['Hello, I\'m Jaugon', 'I\'m a Developer', 'I Create Websites', 'I Build Solutions'],
    typeSpeed: 100,
    backSpeed: 60,
    loop: true
});
